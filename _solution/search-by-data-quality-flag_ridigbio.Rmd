---
title: "How to search for specimen records based on data quality flag, using R and iDigBio"
output:
  html_document:
    code_folding: show
    df_print: kable
---
Code here written by [Erica Krimmel](https://orcid.org/0000-0003-3192-0080). Please see **Use Case: [Search based on data quality flag](https://biodiversity-specimen-data.github.io/specimen-data-use-case/use-case/search-by-data-quality-flag)** for context.
